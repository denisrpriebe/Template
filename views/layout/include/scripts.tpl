...
<script src="<[View::asset('components/material-kit/assets/js/bootstrap-datepicker.js')]>"></script>

<script src="<[View::asset('components/material-kit/assets/js/material.min.js')]>"></script>
<script src="<[View::asset('components/material-kit/assets/js/nouislider.min.js')]>"></script>
<script src="<[View::asset('components/material-kit/assets/js/material-kit.js')]>"></script>
